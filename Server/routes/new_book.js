...
router.post('/info', function(req, res, next) {
    ...
    if(req.session.User) {
        ...
        query_insert_book += " VALUES (NULL, '" + req.session.User.user_id + "', '" + title + "', '" + price + "', '" + status + "', '" + type_of_book + "', '" + author + "', '" + phone_number + "', '" + position + "', '" + description + "', current_timestamp(), 'Đang bán')";
